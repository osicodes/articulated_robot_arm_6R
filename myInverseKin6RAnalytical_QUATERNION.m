% 
% INVERSE KINEMATICS
% analytical with Quaternion angles
% 

function angles = myInverseKin6RAnalytical_QUATERNION(x,y,z,qw,qx,qy,qz)
...
% World to base
w_b_T_pose = [0 0 0 1 0 0 0];
w_b_T = r_QUATERNION_POSE(w_b_T_pose);

% End effector to task
e_t_T_pose = [0 0 0 1 0 0 0];
e_t_T = r_QUATERNION_POSE(e_t_T_pose);
 
% world to task
% w_t_T_pose = [100.3553 50 70.8553 0 0 pi pi];
w_t_T_pose = [x y z qw qx qy qz];
w_t_T = r_QUATERNION_POSE(w_t_T_pose);
