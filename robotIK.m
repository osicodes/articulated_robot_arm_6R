...
%   $Revision: $ $Date: $
%
%   Generated on 11-Aug-2022 01:28:49


dhParams = [0.353553 -1.5707963267949 0.753553 0;0.8 0 0 0;0 -1.5707963267949 0 0;0 1.5707963267949 1 0;0 -1.5707963267949 -2.46519032881566e-32 0;0 0 0.525 0];
...
eeToJt5 = [1 0 0 0;0 6.12323399573677e-17 -1 -1.23259516440783e-32;0 1 6.12323399573677e-17 -0.525;0 0 0 1];
...
hSolns = solveForHGeneralCase(R3, z, a1, a2, a3, alpha1, alpha2, alpha3, d2, d3, d4);
...
% Helper functions
    ...
    function [hSolns, hasFiniteNumSol] = solveForHGeneralCase(R3, z3, a1, a2, a3, alpha1, alpha2, alpha3, d2, d3, d4)
